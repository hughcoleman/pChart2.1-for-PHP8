...
class pDraw
{
    ...
    var array $aColorCache = [];

    /* Returns the number of drawable series */
    function countDrawableSeries(): int
    {
        $Results = 0;
    ...
    /* Fix box coordinates */
    function fixBoxCoordinates($Xa, $Ya, $Xb, $Yb): array
    {
        return [
            min($Xa, $Xb),
            min($Ya, $Yb),
    ...
    /* Draw a polygon */
    function drawPolygon($Points, array $Format = []): void
    {
        $R = $Format["R"] ?? 0;
        $G = $Format["G"] ?? 0;
        $B = $Format["B"] ?? 0;
    ...
    /* Draw a rectangle with rounded corners */
    function drawRoundedFilledRectangle_deprecated($X1, $Y1, $X2, $Y2, $Radius, array $Format = []): void # UNUSED
    {
        $R = 0;
        $G = 0;
        $B = 0;
    ...
    /* Draw a rectangle */
    function drawRectangle($X1, $Y1, $X2, $Y2, array $Format = []): void
    {
        $R = $Format["R"] ?? 0;
        $G = $Format["G"] ?? 0;
        $B = $Format["B"] ?? 0;
    ...
    function drawFilledRectangle($X1, $Y1, $X2, $Y2, array $Format = []): void
    {
    ...
    function drawRectangleMarker($X, $Y, array $Format = []): void
    {
        $Size = $Format["Size"] ?? 4;
    ...
    function drawBezier($X1, $Y1, $X2, $Y2, $Xv1, $Yv1, $Xv2, $Yv2, array $Format = []): array
    {
    ...
    function drawLine($X1, $Y1, $X2, $Y2, array $Format = []): array|int # FAST
    {
        $R = $Format["R"] ?? 0;
        $G = $Format["G"] ?? 0;
        $B = $Format["B"] ?? 0;
    ...
    /* Draw a circle */
    function drawCircle($Xc, $Yc, $Height, $Width, array $Format = []): void
    {
    ...
    /* Draw an arrow */
    function drawArrow($X1, $Y1, $X2, $Y2, array $Format = []): void
    {
    ...
    function drawProgress($X, $Y, $Percent, array $Format = []): void
    {
    ...
    function getLegendSize(array $Format = []): array
    {
        $FontName = $this->FontName;
        $FontSize = $this->FontSize;
        $BoxSize = 5;
    ...
    function drawLegend($X, $Y, array $Format = []): void
    {
    ...
    function drawScale(array $Format = []): void
    {
    ...
    function isValidLabel($Value, $LastValue, $LabelingMethod, $ID, $LabelSkip): bool
    {
    ...
    function processScale($XMin, $XMax, $MaxDivs, $Factors, $AxisID): array
    {
    ...
    function modulo($Value1, $Value2): int
    {
    ...
    /* Draw a line chart */
    function drawLineChart(array $Format = []): void
    {
        $BreakVoid = TRUE;
        $VoidTicks = 4;
        $BreakR = NULL;
    ...
    /* Draw a step chart */
    function drawStepChart(array $Format = []): void
    {
        $BreakVoid = FALSE;
        $ReCenter = TRUE;
        $VoidTicks = 4;
    ...
    /* Draw a step chart */
    function drawFilledStepChart(array $Format = []): void
    {
        $ReCenter = TRUE;
        $DisplayValues = FALSE;
        $DisplayOffset = 2;
    ...
    /* Draw an area chart */
    function drawAreaChart(array $Format = []): void
    {
        $DisplayValues = FALSE;
        $DisplayOffset = 2;
        $DisplayColor = DISPLAY_MANUAL;
    ...
    /* Draw a bar chart */
    function drawStackedBarChart(array $Format = []): void
    {
        $DisplayValues = FALSE;
    ...
    function drawStackedAreaChart(array $Format = []): void
    {
        $DrawLine = FALSE;
    ...
    function getRandomColor($Alpha = 100): array
    {
        return ["R" => rand(0, 255),"G" => rand(0, 255),"B" => rand(0, 255),"Alpha" => $Alpha];
    }

    /* Validate a palette */
    function validatePalette($Colors, $Surrounding = NULL): array
    {
        $Result = [];
    ...
    function drawDerivative(array $Format = []): void
    {
        $Offset = 10;
        $SerieSpacing = 3;
        $DerivativeHeight = 4;
    ...
    function drawBestFit(array $Format = []): void
    {
    ...
    /* Write labels */
    function writeLabel($SeriesName, $Indexes, array $Format = []): void
    {
        $OverrideTitle = NULL;
        $ForceLabels = NULL;
    ...
    /* Draw a basic shape */
    function drawShape($X, $Y, $Shape, $PlotSize, $PlotBorder, $BorderSize, $R, $G, $B, $Alpha, $BorderR, $BorderG, $BorderB, $BorderAlpha): void
    {
